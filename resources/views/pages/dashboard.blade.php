                                            ...
                                            <ul class="tasks">
                                                <li class="outline-badge-success border-0 d-flex py-3 px-2 zoom">
                                                    <label class="chkbox d-flex">
                                                        ...
                                                        <img src="dist/images/author.jpg" alt="author" width="30" height="30" class="rounded-circle"/>
                                                        <img src="dist/images/author2.jpg" alt="author" width="30"  height="30" class="rounded-circle"/>
                                                ...
                                                <li class="outline-badge-warning border-0 d-flex py-3 px-2 zoom">
                                                    <label class="chkbox d-flex">
                                                        <input type="checkbox">                                                      
                                                        <img src="dist/images/author2.jpg" alt="author" width="30" height="30" class="rounded-circle "/>
                                                        <img src="dist/images/author3.jpg" alt="author" width="30" height="30" class="rounded-circle"/>
                                                ...
                                                <li class="outline-badge-info border-0 d-flex py-3 px-2 zoom">
                                                    <label class="chkbox d-flex">
                                                        <input type="checkbox">                                                      
                                                        <img src="dist/images/author3.jpg" alt="author" width="30" height="30" class="rounded-circle "/>
                                                        <img src="dist/images/author7.jpg" alt="author" width="30" height="30" class="rounded-circle"/>
                                                ...
                                                <li class="outline-badge-secondary border-0 d-flex py-3 px-2 zoom">
                                                    <label class="chkbox d-flex">
                                                        <input type="checkbox">                                                      
                                                        <img src="dist/images/author6.jpg" alt="author" width="30" height="30" class="rounded-circle "/>
                                                        <img src="dist/images/author8.jpg" alt="author" width="30" height="30" class="rounded-circle"/>
                    ...
                    <div class="col-12  col-md-6 col-lg-4 mt-3">
                        ...
                        <div class="card promoting-card">
                            ...
                            <div class="card-body d-flex flex-row">
                                ...
                                <!-- Avatar -->
                                <img src="dist/images/author1.jpg" class="rounded-circle mr-3" height="50" width="50" alt="avatar">
                            ...
                            <div class="view overlay">
                                <img class="card-img-top rounded-0" src="dist/images/portfolio13.jpg" alt="Card image cap">
